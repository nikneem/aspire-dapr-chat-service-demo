...
param containerAppsEnvironmentId = '/subscriptions/{subscription-id}/resourceGroups/aspirichat-dev-rg/providers/Microsoft.App/managedEnvironments/{container-apps-environment-name}'
